...
fun ConfigurationLazyColumn(
    configurationsList: List<com.example.data.model.entities.data_class.Configuration>,
...
private fun AccessoryLazyColumnPreview() {
    AppTheme() {
        ...
        ConfigurationLazyColumn(listOf(com.example.data.model.entities.data_class.Configuration()), navController)
    }
}